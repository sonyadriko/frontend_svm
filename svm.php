    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content flex min-h-screen flex-col">
            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                <div>
                    <form action="svm.php" method="get">
                        <label for="gamma">Gamma:</label>
                        <input type="text" id="gamma" name="gamma" required><br><br>

                        <label for="lambda">Lambda (C):</label>
                        <input type="text" id="lambda" name="lambda" required><br><br>

                        <label for="complexity">Complexity (coef0):</label>
                        <input type="text" id="complexity" name="complexity" required><br><br>
